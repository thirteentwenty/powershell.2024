...
.NOTES
    ...
    the connection scope "ReportSettings.ReadWrite.All" is needed
    for this.
...
function connecToGraph {
    Connect-MgGraph -Scopes "User.Read.All","AuditLog.Read.All", "ReportSettings.ReadWrite.All" -NoWelcome    
}
